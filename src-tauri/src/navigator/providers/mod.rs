...
/// Canonical event names POSTed by hooks/copiwaifu-hook.js (Claude Code) and
/// hooks/copiwaifu-opencode.js (OpenCode plugin), plus the raw Claude Code
/// hook names as a courtesy so manual curl tests work unchanged.
///
